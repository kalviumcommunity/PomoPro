  ...
  return (
    <View className="flex-1">
      ...
      <View className="flex-1 items-center justify-center">
        ...
        <Field placeholder="Email" delay={150} />
        <Field placeholder="Password" delay={250} secure />
        <Animated.View style={[{ width: '86%', marginTop: 16 }, btnStyle]}>
          ...
          >
            <Text className="text-black font-extrabold text-base">Sign In</Text>
          </Pressable>
        </Animated.View>
        <Pressable onPress={() => router.replace('/sign-up')} className="mt-4">
          <Text className="text-white/85">Don’t have an account? <Text className="font-extrabold">Sign Up</Text></Text>
        </Pressable>
      </View>
    </View>
  );
